...
namespace BookmarkUI.My
{
	sealed partial class MyProject
	{
		...
		{
			global::BookmarkUI.frmBookmark_loader frmBookmark_loader_instance;
			bool frmBookmark_loader_isCreating;
			public global::BookmarkUI.frmBookmark_loader frmBookmark_loader {
				[DebuggerStepThrough] get { return GetForm(ref frmBookmark_loader_instance, ref frmBookmark_loader_isCreating); }
				[DebuggerStepThrough] set { SetForm(ref frmBookmark_loader_instance, value); }
			}
